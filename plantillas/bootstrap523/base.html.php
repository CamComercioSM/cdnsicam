    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <footer class="text-muted text-center text-small footer ">
            ...
            {% endblock %}
            <small class="mb-1">Cámara de Comercio de Santa Marta para el Magdalena &copy; {{ "now"|date("Y")}}{% if Config.LoginColaboradores %} - {% if Usuario %}<a class="nav-link" href="javascript:cerrarSesionColaborador();">Cerrar Sesión [{{Usuario.usuarioNOMBRE}}]</a>{% endif %}{% endif %}</small>
        </footer>   
